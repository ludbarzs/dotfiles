...
-- Create the custom RuffFix command
vim.api.nvim_create_user_command('RuffFix', 'silent !ruff check % && ruff fix %', { nargs = 0 })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      require('tokyonight').setup {
        styles = {
          comments = { italic = true }, -- Disable italics in on_highlights = function(hl, colors)
        },
        on_highlights = function(hl, colors)
          hl.Function = { fg = colors.blue, bold = true }      -- Make functions bold and blue
          hl.Identifier = { fg = colors.green, italic = true } -- Make identifiers green and italic
        end,
      }
