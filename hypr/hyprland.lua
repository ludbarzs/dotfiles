...
--   hl.exec_cmd("wallust run Pictures/ginger.jpg")
...
--
--         col = {
--           active_border   = { colors = { "rgba(d08f2aee)", "rgba(969992ee)" }, angle = 10 },
--           inactive_border = "rgba(372817aa)",
--         },
--
...
-- -- hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("wofi --show drun"), { release = true })
